...
<div class="card mb-5 border-0 rounded zoom" style="background: #fafafa;"> \
<a href="https://krebsonsecurity.com/2022/12/happy-13th-birthday-krebsonsecurity/" target="_blank" style="text-decoration:none"> \
<img src="https://krebsonsecurity.com/wp-content/uploads/2022/12/nortcrypto.png" class="card-img-top img-fluid" alt="..."> \
<div class="card-body p-0 mx-0 my-3" style="letter-spacing: 0.07rem;font-family:serif;color:#ADADAD;;font-size:12px"> \
<small class="text-uppercase font-weight-bold"><span>Cyber Knowledge</span> <span class="mx-1">&bullet;</span> <span>December 29, 2022</span></small> \
<h5 class="card-link text-dark font-weight-bold my-3">Happy 13th Birthday, KrebsOnSecurity!</h5> \
</div> \
</a> \
</div> \
<div class="card mb-5 border-0 rounded zoom" style="background: #fafafa;"> \
