...
<h2 class="card-link text-dark font-weight-bold my-3">Meta failing to stamp out cyberbullying, says report</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">Australian court orders Google to pay $43 million for misleading users</h2> \
</div> \
</a> \
</div> \
</div> \
