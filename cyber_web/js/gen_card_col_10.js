...
<h2 class="card-link text-dark font-weight-bold my-3">A Pro-China Disinfo Campaign Is Targeting US Elections—Badly</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">Parcel delivery scams are on the rise: Do you know what to watch out for?</h2> \
</div> \
</a> \
</div> \
</div> \
