...
<h2 class="card-link text-dark font-weight-bold my-3">S3 Ep128: So you want to be a cyber­criminal? [Audio + Text]</h2> \
</div> \
</a> \
</div> \
</div> \
...
<div class="card-body p-0 mx-0 my-3" style="letter-spacing: 0.07rem;font-family:serif;color:#ADADAD;font-size:12px"> \
<small class="text-uppercase font-weight-bold"><span>Cyber Knowledge</span> <span class="mx-1">&bullet;</span> <span>March 30, 2023</span></small> \
<h2 class="card-link text-dark font-weight-bold my-3">The US Is Sending Money to Countries Devastated by Cyberattacks</h2> \
</div> \
</a> \
</div> \
</div> \
