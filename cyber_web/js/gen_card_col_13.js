...
<h2 class="card-link text-dark font-weight-bold my-3">Nomad: a flaw outlined by the audit firm is not related to a recent hack</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">Reddit awards hero hacker $10k bounty</h2> \
</div> \
</a> \
</div> \
</div> \
