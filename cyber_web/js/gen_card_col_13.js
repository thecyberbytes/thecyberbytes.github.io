...
<h2 class="card-link text-dark font-weight-bold my-3">North Korean hackers use fake Coinbase job ads to lure crypto buffs</h2> \
</div> \
</a> \
</div> \
</div> \
...
<div class="card-body p-0 mx-0 my-3" style="letter-spacing: 0.07rem;font-family:serif;color:#ADADAD;font-size:12px"> \
<small class="text-uppercase font-weight-bold"><span>Ransomware</span> <span class="mx-1">&bullet;</span> <span>August 08, 2022</span></small> \
<h2 class="card-link text-dark font-weight-bold my-3">British architecture firm suffers a ransomware attack</h2> \
</div> \
</a> \
</div> \
</div> \
