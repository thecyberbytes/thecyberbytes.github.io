...
<h2 class="card-link text-dark font-weight-bold my-3">DOJ Charges Binance With Vast Money-Laundering Scheme and Sanctions Violations</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">Secretive White House Surveillance Program Gives Cops Access to Trillions of US Phone Records</h2> \
</div> \
</a> \
</div> \
</div> \
