...
<h2 class="card-link text-dark font-weight-bold my-3">Serious Security: How dEliBeRaTe tYpOs might imProVe DNS security</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">Flaw in Diksha App Exposed the Data of Millions of Indian Students</h2> \
</div> \
</a> \
</div> \
</div> \
