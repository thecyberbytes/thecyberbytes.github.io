...
<h2 class="card-link text-dark font-weight-bold my-3">Administrator of RSOCKS Proxy Botnet Pleads Guilty</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">Hybrid play: Leveling the playing field in online video gaming and beyond</h2> \
</div> \
</a> \
</div> \
</div> \
