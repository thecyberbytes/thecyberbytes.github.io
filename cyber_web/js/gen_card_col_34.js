...
<h5 class="card-link text-dark font-weight-bold my-3">New ‘Retbleed’ Attack Can Swipe Key Data From Intel and AMD CPUs</h5> \
</div> \
</a> \
</div> \
<div class="card mb-5 border-0 rounded zoom" style="background: #fafafa;"> \
...
<h5 class="card-link text-dark font-weight-bold my-3">The January 6 Insurrection Hearings Are Just Heating Up</h5> \
</div> \
</a> \
</div> \
');