...
<h2 class="card-link text-dark font-weight-bold my-3">Feds: Zeppelin Ransomware Resurfaces with New Compromise, Encryption Tactics</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">Sounding the Alarm on Emergency Alert System Flaws</h2> \
</div> \
</a> \
</div> \
</div> \
