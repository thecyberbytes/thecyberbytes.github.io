...
<h2 class="card-link text-dark font-weight-bold my-3">Journalists Emerge as Favored Attack Target for APTs</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">Large-Scale Phishing Campaign Bypasses MFA</h2> \
</div> \
</a> \
</div> \
</div> \
