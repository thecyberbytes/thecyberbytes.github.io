...
<h2 class="card-link text-dark font-weight-bold my-3">Using Google Search to Find Software Can Be Risky</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">Canadian Man Stuck in Triangle of E-Commerce Fraud</h2> \
</div> \
</a> \
</div> \
</div> \
