...
<h2 class="card-link text-dark font-weight-bold my-3">A Leak Details Apple\'s Secret Dirt on Corellium, a Trusted Security Startup</h2> \
</div> \
</a> \
</div> \
</div> \
...
<div class="card-body p-0 mx-0 my-3" style="letter-spacing: 0.07rem;font-family:serif;color:#ADADAD;font-size:12px"> \
<small class="text-uppercase font-weight-bold"><span>Cyber Knowledge</span> <span class="mx-1">&bullet;</span> <span>November 21, 2022</span></small> \
<h2 class="card-link text-dark font-weight-bold my-3">Autonomous Vehicles Join the List of US National Security Threats</h2> \
</div> \
</a> \
</div> \
</div> \
