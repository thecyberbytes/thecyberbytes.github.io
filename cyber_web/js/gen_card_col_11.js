...
<h2 class="card-link text-dark font-weight-bold my-3">S3 Ep100: Browser-in-the-Browser – how to spot an attack  [Audio + Text]</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">The Twitter Whistleblower’s Testimony Has Senators Out for Blood</h2> \
</div> \
</a> \
</div> \
</div> \
