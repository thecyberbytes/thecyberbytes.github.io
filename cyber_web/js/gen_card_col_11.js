...
<h2 class="card-link text-dark font-weight-bold my-3">Popular JWT cloud security library patches “remote” code execution hole</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">StrongPity espionage campaign targeting Android users</h2> \
</div> \
</a> \
</div> \
</div> \
