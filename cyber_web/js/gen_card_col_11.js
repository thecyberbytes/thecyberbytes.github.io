...
<h2 class="card-link text-dark font-weight-bold my-3">Zeppelin ransom gang executes malware multiple times within a victim’s network</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">Boston crook jailed for scamming elderly online</h2> \
</div> \
</a> \
</div> \
</div> \
