...
<h2 class="card-link text-dark font-weight-bold my-3">2 Polish Men Arrested for Radio Hack That Disrupted Trains</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">Why is .US Being Used to Phish So Many of Us?</h2> \
</div> \
</a> \
</div> \
</div> \
