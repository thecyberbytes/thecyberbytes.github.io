...
<h2 class="card-link text-dark font-weight-bold my-3">Ransomware rages on – Week in security with Tony Anscombe</h2> \
</div> \
</a> \
</div> \
</div> \
...
<h2 class="card-link text-dark font-weight-bold my-3">The OpenSSL security update story – how can you tell what needs fixing?</h2> \
</div> \
</a> \
</div> \
</div> \
