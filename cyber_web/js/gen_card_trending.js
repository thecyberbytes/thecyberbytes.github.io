...
<div class="card-body p-0 mx-0 my-3" style="letter-spacing: 0.07rem;font-family:serif;color:#ADADAD;;font-size:10px"> \
<h6 class="card-link text-dark font-weight-bold my-3">Interested in cybersecurity? Join us for Security SOS Week 2022!</h6> \
</div> \
</a> \
</li> \
<li class="list-group-item" style="background: #fafafa;"> \
...
<div class="card-body p-0 mx-0 my-3" style="letter-spacing: 0.07rem;font-family:serif;color:#ADADAD;;font-size:10px"> \
<h6 class="card-link text-dark font-weight-bold my-3">LastPass source code breach – incident response report released</h6> \
</div> \
</a> \
</li> \
<li class="list-group-item" style="background: #fafafa;"> \
