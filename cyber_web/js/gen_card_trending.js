...
<div class="card-body p-0 mx-0 my-3" style="letter-spacing: 0.07rem;font-family:serif;color:#ADADAD;;font-size:10px"> \
<h6 class="card-link text-dark font-weight-bold my-3">Fantasy – a new Agrius wiper deployed through a supply‑chain attack</h6> \
</div> \
</a> \
</li> \
<li class="list-group-item" style="background: #fafafa;"> \
...
<div class="card-body p-0 mx-0 my-3" style="letter-spacing: 0.07rem;font-family:serif;color:#ADADAD;;font-size:10px"> \
<h6 class="card-link text-dark font-weight-bold my-3">Tractors vs. threat actors: How to hack a farm</h6> \
</div> \
</a> \
</li> \
');