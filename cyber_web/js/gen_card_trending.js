...
<div class="card-body p-0 mx-0 my-3" style="letter-spacing: 0.07rem;font-family:serif;color:#ADADAD;;font-size:10px"> \
<h6 class="card-link text-dark font-weight-bold my-3">Meta Abandons Hacking Victims, Draining Law Enforcement Resources, Officials Say</h6> \
</div> \
</a> \
</li> \
<li class="list-group-item" style="background: #fafafa;"> \
...
<div class="card-body p-0 mx-0 my-3" style="letter-spacing: 0.07rem;font-family:serif;color:#ADADAD;;font-size:10px"> \
<h6 class="card-link text-dark font-weight-bold my-3">A Mysterious Leak Exposed Chinese Hacking Secrets</h6> \
</div> \
</a> \
</li> \
<li class="list-group-item" style="background: #fafafa;"> \
