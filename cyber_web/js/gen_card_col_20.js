...
<img src="https://nakedsecurity.sophos.com/wp-content/uploads/sites/2/2023/03/throne-1200-1.jpg?w=230&h=130&crop=1" class="card-img-top img-fluid" alt="..."> \
<div class="card-body p-0 mx-0 my-3" style="letter-spacing: 0.07rem;font-family:serif;color:#ADADAD;;font-size:12px"> \
<small class="text-uppercase font-weight-bold"><span>Ransomware</span> <span class="mx-1">&bullet;</span> <span>March 03, 2023</span></small> \
<h5 class="card-link text-dark font-weight-bold my-3">Feds warn about right Royal ransomware rampage that runs the gamut of TTPs</h5> \
</div> \
</a> \
</div> \
<div class="card mb-5 border-0 rounded zoom" style="background: #fafafa;"> \
