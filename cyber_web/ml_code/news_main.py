...
def main():
    ...
    tdidf_filename = '../models/trained_tfidf.pkl'  # the trained TD-IDF vector
    cat_filename = '../models/category_dict.pkl'  # the news category dict
    ...
    # load the test data
    news_test_df = pd.read_excel("../excels/Book3.xlsx")
    ...
    submit_test.to_excel("../excels/news_categorized.xlsx", index=False)
